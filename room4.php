                ...
                <div class="col-lg-8">
                    <div class="room-details-item">
                        ...
                        <div class="hero-slider owl-carousel hero-slider-rooms mb30">
                            <div class="hs-item set-bg" data-setbg="img/room/Люкс01.JPG"></div>
                            <div class="hs-item set-bg" data-setbg="img/room/Люкс02.JPG"></div>
                            <div class="hs-item set-bg" data-setbg="img/room/Люкс03.JPG"></div>
                            <div class="hs-item set-bg" data-setbg="img/room/Люкс04.JPG"></div>
                        </div>
                        <div class="rd-text">
                            <div class="rd-title">
                                <h3>Люкс</h3>
