                ...
                <div class="col-lg-8">
                    <div class="room-details-item">
                        ...
                        <div class="hero-slider owl-carousel hero-slider-rooms mb30">
                            <div class="hs-item set-bg" data-setbg="img/room/Твин01.JPG"></div>
                            <div class="hs-item set-bg" data-setbg="img/room/Твин02.JPG"></div>
                            <div class="hs-item set-bg" data-setbg="img/room/Твин03.JPG"></div>
                            <div class="hs-item set-bg" data-setbg="img/room/Твин04.JPG"></div>
                        </div>
                        <div class="rd-text">
                            <div class="rd-title">
                                <h3>Джуниор Твин</h3>
